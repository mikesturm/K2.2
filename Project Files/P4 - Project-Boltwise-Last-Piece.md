...
+ Get feedback from Karla on getting access for: Mike Schewe, Dan Cox, Jacob Potter, Leo Rivas
  ...
  - Current process = LP team works directly in PFEP, then exports & sends them to Sourcing
  - Karla: Sourcing's process is that everything starts in Boltwise, then goes to Qstrat
  - Long-term goal is to have all Quoting in Boltwise to start with and always quote with it.
  - Karla will get the guys logins & training
